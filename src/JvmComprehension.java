...
public class JvmComprehension {
  ...
  // и перемещается в Metaspace для сохранения данных о  JvmComprehension.
  public static void main(String[] args) {
    // В момент вызова метода main создается фрейм в Stack'е.
    int i = 1;                      // 1 В main создается переменная i со значением 1.
    Object o = new Object();        // 2 В Куче создается объект Object и в main создается переменная o,
